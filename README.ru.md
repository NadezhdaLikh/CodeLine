# CodeArena - образовательная платформа для интерактивного изучения языков программирования
...
Подразумевается, что веб-приложение и компилятор размещены на отдельных серверах и взаимодействуют между собой посредством обмена HTTP-сообщениями, однако на стадии разработки все компоненты приложения: база данных PostgreSQL, бэкенд, фронтенд и компилятор – запускались на разных портах одного локального сервера.
...
На стадии разработки база данных PostgreSQL, бэкенд и компилятор запускались на разных портах одного локального сервера.
...
Процедура аутентификации и авторизации одинаковая для всех пользователей, однако регистрация осуществляться по-разному: студенты регистрируются сами, а новых преподавателей добавляет администратор. Администратору регистрироваться в системе не нужно.
